...
Configuration files and a run script are available as a gzipped tar archive [spec2k6-2.24.tar.gz, MD5=a42e12acbc1ef533b3c1328b77c14b01}](/attachments/spec2k6-2.24.tar.gz)).
...
![cpu_vs_rate](/images/speed_vs_rate.gif){:.centered-image}
